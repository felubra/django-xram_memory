    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pdf_document', filer.fields.file.FilerFileField(on_delete=django.db.models.deletion.CASCADE, related_name='pdf_captures', to='filer.File', verbose_name='Documento PDF')),
            ],
            options={
