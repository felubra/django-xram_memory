...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('taxonomy', '0002_auto_20190311_1738'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='newspaper',
            name='logo',
            field=filer.fields.file.FilerFileField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='filer.File', verbose_name='Logotipo'),
        ),
        migrations.AddField(
            model_name='newspaper',
            name='modified_by',
        ...
        migrations.AddField(
            model_name='document',
            name='file',
            field=filer.fields.file.FilerFileField(null=True, on_delete=django.db.models.deletion.CASCADE, to='filer.File', verbose_name='Arquivo'),
        ),
        migrations.AddField(
            model_name='document',
            name='keywords',
