...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='pdf_document',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='artifact.PDFDocument'),
        ),
        migrations.AddField(
            model_name='newsimagecapture',
            name='image_document',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='artifact.ImageDocument'),
        ),
    ]
