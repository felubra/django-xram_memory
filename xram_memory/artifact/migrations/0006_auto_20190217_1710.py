# Generated by Django 2.1.5 on 2019-02-17 20:10
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('artifact', '0005_auto_20190213_1753'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='newssource_creator', to=settings.AUTH_USER_MODEL, verbose_name='Criado por')),
                ('modified_by', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='newssource_last_modifier', to=settings.AUTH_USER_MODEL, verbose_name='Modificado por')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='news',
            name='news_source',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='artifact.NewsSource'),
        ),
    ]
