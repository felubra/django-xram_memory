...
class StaticPageAdminForm(forms.ModelForm):
    class Meta:
        EDITOR_COLORS = json.dumps(["#e60000", "#ff9900", "#ffff00", "#008a00", "#0066cc",
                                    ...
                                    "#e60000", "#ff9900", "#ffff00", "#008a00", "#0066cc",
                                    "#9933ff", "#facccc", "#ffebcc", "#ffffcc", "#cce8cc",
                                    "#cce0f5", "#ebd6ff", "#bbbbbb", "#f06666", "#ffc266",
                                    "#ffff66", "#66b966", "#66a3e0", "#c285ff", "#888888",
                                    "#a10000", "#b26b00", "#b2b200", "#006100", "#0047b2",
