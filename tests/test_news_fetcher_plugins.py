...
def test_usage_of_default_pdf_capture_plugin(datadir, mocker):
    ...
    """
    mocker.patch(
        "xram_memory.lib.news_fetcher.plugins.defaults.DefaultPDFCapture.get_pdf_capture"
    )
...
def test_usage_of_specialized_pdf_capture_plugin(datadir, mocker):
    ...
    mocker.patch(
        "xram_memory.lib.news_fetcher.plugins.pdf_captures.G1PDFCapture.get_pdf_capture"
    )
