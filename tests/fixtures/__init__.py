...
NEWS_INFO_MOCK = {
    "authors": "Ana Carolina Cortez,Eraldo Peres",
    ...
    "subjects": ["Pedaladas fiscais", "Governo Dilma Rousseff"],
...
NEWS_ITEMS = [
    {
        ...
        "subjects": ["Active Third Age", "World Wrestling Championship"],
    },
    {
        ...
        "subjects": ["Sobrenatural Humans", "Proud-to-be grandmothers"],
    },
]
...
def news_fetcher_plugin_factory(
    registry, plugins_to_build=[FunctionalPlugin, FunctionalPlugin, FunctionalPlugin]
):
    """
